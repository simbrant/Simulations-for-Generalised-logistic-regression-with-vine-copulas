...
mu_0 <- as.numeric(read.csv("parameters_14/mu_0.csv")[, 1])
mu_1 <- as.numeric(read.csv("parameters_14/mu_1.csv")[, 1])
sigma_0 <- as.numeric(read.csv("parameters_14/sigma_0.csv")[, 1])
sigma_1 <- as.numeric(read.csv("parameters_14/sigma_1.csv")[, 1])
R_1 <- as.matrix(read.csv("parameters_14/R_1.csv"))
R_0 <- as.matrix(read.csv("parameters_14/R_0.csv"))
